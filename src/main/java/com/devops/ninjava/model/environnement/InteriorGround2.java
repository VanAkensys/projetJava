...
public class InteriorGround2 extends Ground {

    public InteriorGround2(double x, double y) {
    ...
    protected void initializeImages() {
        try {
            ...
            Image brickImage = SwingFXUtils.toFXImage(spriteSheet.getSubimage(32, 80, 32, 32), null);
